...
{
print $val;
`curl -d '{"switch": "00:00:06:cf:71:04:7a:41", "name":"f$val", "cookie":"0", "priority":"32768","active":"true", "src-ip":"192.168.1.2", "dst-ip":"$val", "ether-type":"0x800", "actions":""}' http://192.168.3.1:8080/wm/staticflowentrypusher/json`;
